...
public abstract class ManagerSup{
     ...
     */
    protected HandlerList getHandlerListByClazz(Class<? extends Event> type){
        try {
    ...
    protected abstract void fireEvent(Event event, RegisteredListener[] registeredListeners);
}
